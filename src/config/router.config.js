...

  {
    ...
    children: [
      ...
      // project
      {
        ...
        name: 'project',
        component: RouteView,
        redirect: '/project/task-management',
        meta: { title: '项目管理页', icon: 'project', permission: [ 'project' ] },
        children: [
          {
            path: '/project/task-management',
            name: 'TaskManagement',
            component: () => import('@/views/project/TaskManagement'),
            meta: { title: '项目管理', permission: ['project'] }
          },
          {
