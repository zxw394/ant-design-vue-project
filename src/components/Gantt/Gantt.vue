...
<script>
import '@/components/Gantt/ganttBeautiful'
import '@/components/Gantt/critical_path'
import '@/components/Gantt/auto_scheduling'
import '@/components/Gantt/gantt_undo'
...
function customizeAutoSchedule () {
  ...
  gantt.eachUpdate = function (root) {
    const moveTask = gantt.getTask(root)
    const moveTaskTarget = []
